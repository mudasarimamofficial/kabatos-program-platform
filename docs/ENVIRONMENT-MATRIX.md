...
# 2026-09-17 Stripe TEST acceptance deployment

Stripe TEST Acceptance Preview: `https://kabatos-stripe-test.vercel.app` (Deployment `dpl_DB55kE5b9Wurp2hJuKMjZemsdGGn`), connected to Supabase DEV `finbvtwjddrmbuuuyeni` and Stripe TEST account with dedicated webhook endpoint `we_1UGiPVRCnOFy7ZssdVtvIOvI`. Zero connection to Supabase PROD or Stripe LIVE.
